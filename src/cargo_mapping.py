...
# Class to map the cargo and the truck
...
class CargoMapping:
    ...
    def map_cargo_to_trucks(self):
        ...
        for cargo in self.cargos:
            for truck in self.trucks:
                ...
                actual_distance = truck.travel_to(
                    cargo.origin,
                    cargo.destination,
                ...
                cargo.all_possible_distances.append(
                    {'id': truck.id, 'distance': actual_distance})
            self.trucks.remove(cargo.truck_booking)

            self.all_distances[cargo.id] = sorted(
                cargo.all_possible_distances, key=lambda l: l['distance'])

    def print_cargo_map(self):
        for cargo in self.cargos:
            print("*************************************************************************************************************************************************")
            print("Cargo ID  : ", cargo.id)
            print("Origin State /Carried By Truck :  ", cargo.truck_booking.id)
            print("Shortest Distance : ", cargo.shortest_distance)
            print("*************************************************************************************************************************************************\n")
    ...
    # def save_shortest_distance(self):
    #     with open('files/shortest_dist.json', 'w') as outfile:
    #         json.dump(self.shortest_distances,outfile)
